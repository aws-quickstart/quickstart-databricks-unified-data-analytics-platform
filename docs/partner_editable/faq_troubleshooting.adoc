...
//TODO Shivansh, In the first reference to *Rollback on failure*, we say *No.* In the second we say *Disabled* ... shouldn't it be the same in both places? (Please fix in the boilerplate file also.)
