...
//TODO The preceding paragraph is supposed to be paragraph #2 of the warning, inside the box. (How do we make that work in AsciiDoc—do we need to keep the whole warning in one paragraph?) Whatever the fix here, please do the same in the boilerplate version of this file too.)
