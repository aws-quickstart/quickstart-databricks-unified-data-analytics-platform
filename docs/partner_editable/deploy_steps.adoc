...
[cols=",]
|===
|https://fwd.aws/KypJd[Option 1. Deploy Databricks workspace creating a new cross-account IAM role^]
|https://fwd.aws/KypJd[Option 2. Deploy Databricks workspace providing an existing cross-account IAM role^] 
|===
