...
[cols=",]
|===
|https://fwd.aws/KypJd[Option 1. Deploy a Databricks workspace and create a new cross-account IAM role^]
|https://fwd.aws/Q3zkp[Option 2. Deploy a Databricks workspace and use an existing cross-account IAM role^] 
|===
